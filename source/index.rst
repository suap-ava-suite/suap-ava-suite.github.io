...
4. **:doc:`Guia do Professor (Docente <source/professor.rst>`**: Manual prático explicando como solicitar a sincronização de diários, como puxar notas do Moodle para o SUAP e a **configuração crítica e obrigatória do livro de notas do Moodle**.
